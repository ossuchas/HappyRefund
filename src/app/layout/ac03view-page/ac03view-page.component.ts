...
@Component({
    selector: 'app-ac03view-page',
    templateUrl: './ac03view-page.component.html',
    styleUrls: ['./ac03view-page.component.scss'],
    animations: [routerTransition()]
})
export class Ac03viewPageComponent implements OnInit {
    constructor(
    ...
    refreshDataList() {
        this.service.getAC03AllList().subscribe(data => {
    ...
    onEdit(hyrf: CrmContactRefund) {
        ...
        this.dialog.open(Ac03edit01PageComponent, dialogConfig);
    }
