...
@Component({
    selector: 'app-tf02imgview-page',
    templateUrl: './tf02imgview-page.component.html',
    styleUrls: ['./tf02imgview-page.component.scss']
})
export class Tf02imgviewPageComponent implements OnInit {
    constructor(
        public dialogbox: MatDialogRef<Tf02imgviewPageComponent>,
